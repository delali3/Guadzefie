...
async function applyMigration() {
  try {
    ...
    const migrationPath = path.join(process.cwd(), 'scripts', 'migrations', 'create_shipping_addresses_table.sql');
    ...
    console.log('The shipping_addresses table is now available for use.');
    ...
    console.log('3. Create a new query and paste the content of scripts/migrations/create_shipping_addresses_table.sql');
